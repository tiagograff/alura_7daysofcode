...
while (ok) {
  let question1 = prompt(
    'deseja adicionar uma comida a sua lista de compras? "sim" ou "não" ou "excluir" um elemento da lista?'
  );
  if (question1 === "sim") {
    ...
    let remove = prompt("o que deseja excluir?");
    switch (question2) {
      case "1":
